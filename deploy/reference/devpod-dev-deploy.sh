#!/usr/bin/env bash
# ═══ RÉFÉRENCE — copie du dev-deploy.sh du repo devpod (2026-07-04) ═══
# Sert de modèle pour harmoniser le process de livraison dev de roles.
# NE PAS exécuter tel quel ici : les chemins/clés sont ceux du portail devpod.
#
